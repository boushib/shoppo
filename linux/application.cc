...
static gboolean application_local_command_line(GApplication* application,
                                               gchar*** arguments,
                                               int* exit_status) {
  Application* self = APPLICATION(application);
...
static void application_class_init(ApplicationClass* klass) {
  ...
  G_APPLICATION_CLASS(klass)->local_command_line =
      application_local_command_line;
...
Application* application_new() {
  return APPLICATION(
      g_object_new(application_get_type(), "application-id", APPLICATION_ID,
